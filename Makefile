...
PACK             := pve-cluster
PACKDIR          := sdk
PROJECT          := github.com/deposition-cloud/pulumi-pve-cluster
NODE_MODULE_NAME := @deposition.cloud/pulumi-pve-cluster
NUGET_PKG_NAME   := DepositionCloud.PulumiProxmoxVECluster
