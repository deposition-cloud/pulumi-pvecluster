...
import (
	...
	"errors"
	"github.com/deposition-cloud/pulumi-pvecluster/sdk/go/pvecluster/internal"
...
func NewRandom(ctx *pulumi.Context,
	...
	var resource Random
	err := ctx.RegisterResource("pvecluster:index:Random", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRandom(ctx *pulumi.Context,
	...
	var resource Random
	err := ctx.ReadResource("pvecluster:index:Random", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
