...
pulumi.runtime.registerResourceModule("pvecluster", "index", _module)
pulumi.runtime.registerResourcePackage("pvecluster", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:pvecluster") {
